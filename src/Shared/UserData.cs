...
public class UserData : DataDocumentDictionary<UserVestingInfo>
{
    public UserData() : base()
    {
    }

    public UserData(long lastUpdated, Dictionary<string, UserVestingInfo> items) : base(lastUpdated, items)
    {
    }
}
// {
