...
namespace Avalaunch.Sale2.ContractDefinition
{


    public partial class Sale2Deployment : Sale2DeploymentBase
    {
        public Sale2Deployment() : base(BYTECODE) { }
        public Sale2Deployment(string byteCode) : base(byteCode) { }
    }

    public class Sale2DeploymentBase : ContractDeploymentMessage
    {
        ...
        """;
        public Sale2DeploymentBase() : base(BYTECODE) { }
        public Sale2DeploymentBase(string byteCode) : base(byteCode) { }
    ...
    public class SaleOutputDTOBase : IFunctionOutputDTO 
    {
        ...
        public virtual BigInteger SaleEnd { get; set; }
        [Parameter("uint256", "tokensUnlockTime", 12)]
        public virtual BigInteger TokensUnlockTime { get; set; }
    }
