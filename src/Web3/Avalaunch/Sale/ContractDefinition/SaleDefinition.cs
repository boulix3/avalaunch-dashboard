...
namespace Avalaunch.Sale.ContractDefinition
{


    public partial class SaleDeployment : SaleDeploymentBase
    {
        public SaleDeployment() : base(BYTECODE) { }
        public SaleDeployment(string byteCode) : base(byteCode) { }
    }

    public class SaleDeploymentBase : ContractDeploymentMessage
    {
        ...
        """;
        public SaleDeploymentBase() : base(BYTECODE) { }
        public SaleDeploymentBase(string byteCode) : base(byteCode) { }
