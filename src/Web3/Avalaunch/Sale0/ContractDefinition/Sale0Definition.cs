...
namespace Avalaunch.Sale0.ContractDefinition
{


    public partial class Sale0Deployment : Sale0DeploymentBase
    {
        public Sale0Deployment() : base(BYTECODE) { }
        public Sale0Deployment(string byteCode) : base(byteCode) { }
    }

    public class Sale0DeploymentBase : ContractDeploymentMessage
    {
        ...
        """;
        public Sale0DeploymentBase() : base(BYTECODE) { }
        public Sale0DeploymentBase(string byteCode) : base(byteCode) { }
