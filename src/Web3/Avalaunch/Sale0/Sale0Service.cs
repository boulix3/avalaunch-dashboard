...
using Avalaunch.Sale0.ContractDefinition;

namespace Avalaunch.Sale0
{
    public partial class Sale0Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, Sale0Deployment sale0Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<Sale0Deployment>().SendRequestAndWaitForReceiptAsync(sale0Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, Sale0Deployment sale0Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<Sale0Deployment>().SendRequestAsync(sale0Deployment);
        }

        public static async Task<Sale0Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, Sale0Deployment sale0Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, sale0Deployment, cancellationTokenSource);
            return new Sale0Service(web3, receipt.ContractAddress);
        }
        ...
        public Sale0Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public Sale0Service(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
